...
impl MetaSlot {
    ...
    pub(super) fn drop_last_in_place(&self)
        ...
        ensures
            ...
            owner.inner_perms.unwrap().ref_count.id() == old(
                owner,
            ).inner_perms.unwrap().ref_count.id(),
            ...
            owner.inner_perms.unwrap().vtable_ptr.pptr() == old(
                owner,
            ).inner_perms.unwrap().vtable_ptr.pptr(),
