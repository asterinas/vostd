...
use aster_common::prelude::{pod::PodOnce, VmIoOwner, VmReader, VmWriter};
...
pub trait VmIo: Send + Sync + Sized {
    ...
    //     self.read(offset, &mut writer, Tracked(owner))
    // }
...
//     fn read_val<T>(&self, offset: usize) -> Result<T> {
